...
@Component({
  selector: 'app-select-branches-modal',
  imports: [CommonModule, FormsModule, Select],
  templateUrl: './select-branches-modal.html',
  styleUrl: './select-branches-modal.scss',
})
export class SelectBranchesModal implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.filiais) {
      this.selectedBranches = new Set<string>(this.filiais);
    }
  }
