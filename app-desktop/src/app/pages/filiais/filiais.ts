...
export class Filiais {
  ...
  // Mock Data
  empresas: Empresa[] = [
    { id: '1', numero: '001', nome: 'CASA DO ADUBO', status: 'Ativo' },
    { id: '2', numero: '002', nome: 'CASAL', status: 'Ativo' },
    { id: '3', numero: '003', nome: 'NUTRIEN', status: 'Inativo' },
  ];

  filiais: Filial[] = [
    { id: '1', numero: '001', nome: 'FILIAL NORTE', empresaId: '1', status: 'Ativo' },
    { id: '2', numero: '002', nome: 'FILIAL SUL', empresaId: '1', status: 'Ativo' },
    { id: '3', numero: '001', nome: 'UNIDADE CENTRAL', empresaId: '2', status: 'Inativo' },
  ];
